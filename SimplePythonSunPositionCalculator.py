"""
This code is adopted from https://github.com/mperezcorrales/SunPositionCalculator.git
...
def getSEA(latitude, longitude, utc_offset, yr, mth, dy, hr, mn):
    date = datetime.datetime(yr, mth, dy, hr, mn).timetuple()
    # print('date', date)
    hour = date[3]
    minute = date[4]
    ...
    return SEA, datetime.datetime(yr, mth, dy, hr, mn)
